...
Contact_db = "Andrew McMahen   8"
Farmer_db  =  "Barney O'Callaghan   2"
Paddock_tested_db  =	"NOC 2"
#Zone_db            = 
data_file       = "NOC_2Yld_Seg_ID_zone.csv"
...
"W:\value_soil_testing_prj\Yield_data\Landmark\Barney_O_Callaghan\Andrew_McMahen\NOC2\NOC_2Yld_Seg_ID_zone.csv"

#As it appears in the file directory
site_details <- paste0(Organisation_db,"_",
                       "Barney_O_Callaghan","_",
                       "Andrew_McMahen", "_",
                       "NOC2")
...
list_rates <- data.frame( rate_name = c("Grower_rate" , "rate1"),
                          Rates = c(Grower_rate,rate1) )
...
#                  SegmentID != 1&
#                  SegmentID != 2)
seg_ID <- dplyr::filter(seg_ID, !between(seg_ID$SegmentID, 1, 4))
...
p_vlaue_text_zone_1 <- paste0("Yield at P ", Grower_rate, " is  P ", rate1, " " ,positive_neg_value_GR_rate1_zone1, " ", 
                              ...
                              zone_av_1_rate1vsGR_res_sig$Significant,collapse = "\n")
...
### should get this from harms database
 ...
 drop_download(path = "N&P 2019 data for analysis Vic 11March2020.xlsx", 
...
harm_database <- read_excel(paste0(
                            database_name_of_path,"/", "N&P 2019 data for analysis Vic 11March2020.xlsx"),
