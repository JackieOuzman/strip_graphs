...
"W:\value_soil_testing_prj\Yield_data\Landmark\Matt_Nihill\Jenharwil_2\L Cali 567\Cail_Yld_Seg_ID_zone.csv"

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Matt Nihill   7"
Farmer_db  =  "Jenharwil 2"
Paddock_tested_db  =	"L Cali 5/6/7"
#Zone_db            = 
...
### should get this from harms database
 ...
 drop_download(path = "GRDC_Soil_Plant_Testing_Database/NP_database_03032020_SA.xlsx", 
