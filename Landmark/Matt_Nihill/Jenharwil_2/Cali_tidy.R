...
##1c. make name consistant
 ...
 #seg_ID <- mutate(seg_ID, Rates_original = Rates)
##1c. Set up data so its generic growers rate, rate1, rate2, rate3, zone1, zone2

#Define the rates
unique(seg_ID$Rates)

Grower_rate = "Rate_1" #this is the value that appear in the input data
rate1 = "Rate_2"
rate2 = "Rate_3"
#rate3 = 110
...
#### This is a problem I am filtering out data that doesnt exist!!!
