...
Paddock_tested_db  =	"East Laundys"
#Zone_db            = 
data_file       = "East_Laudys_Yld_SegID_zone2.csv"
...
"W:\value_soil_testing_prj\Yield_data\Landmark\Matt_Nihill\Litster_Trading\East_Laudys\East_Laudys_Yld_SegID_zone2.csv"
...
harm_database <- read_excel(paste0(
                            database_name_of_path,"/", "NP_database_03032020_SA.xlsx"),
