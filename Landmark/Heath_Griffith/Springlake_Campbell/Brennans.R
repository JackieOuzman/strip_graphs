...
Contact_db = "Heath Griffith  5"
Farmer_db  =  "Springlake Campbell 2"
Paddock_tested_db  =	"Brennans"
#Zone_db            = 
data_file       = "Brennans_Yield_Seg_ID15_zone.csv"
...
seg_ID <- filter(seg_ID, between)
seg_ID <- dplyr::filter(seg_ID, between(seg_ID$SegmentID, 11, 211))
str(seg_ID)
