...
name_of_path <-
  file.path("W:", "value_soil_testing_prj", "Yield_data", "Tim_McClelland", "Top",  "Top_yld_2019_seg_ID.csv")
seg_ID <-read_csv(name_of_path)

graph_path <- file.path("W:", "value_soil_testing_prj", "Yield_data", "Tim_McClelland", "Top")
...
### should get this from harms database
 ...
 str(harm_database)
 Tim_McClelland_Top <- filter(harm_database,
                                   Paddock_tested == "Top clay loam" |
