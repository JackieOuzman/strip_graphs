...
"\\FSSA2-ADL\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Jenharwil\James 2\email_data\James_Yld_Seg_ID_zones.csv"

name_of_path <-
  file.path("W:", "value_soil_testing_prj", "Yield_data", "Jenharwil", "James 2",  "email_data", "James_Yld_Seg_ID_zones.csv")
seg_ID <-read_csv(name_of_path)

graph_path <- file.path("W:", "value_soil_testing_prj", "Yield_data", "Jenharwil", "James 2", "email_data")
seg_ID
