...
"Schilitz_Yld_Seg_ID_zone.csv"	   	

#As it appears in the database
Organisation_db	  = "Vic_Ind"
Contact_db = "Anne_Jackman"
Farmer_db  =  "Schlitz M2"
#Paddock_tested_db  =	"Brennans"
#Zone_db            = 
data_file       = "Schilitz_Yld_Seg_ID_zone.csv"
...
# P rates first
unique(seg_ID$MAP_Urea)
seg_ID <- filter(seg_ID,
                   MAP_Urea == "40MAP_60Urea"|
                   MAP_Urea == "80MAP_60Urea" |
                   MAP_Urea == "20MAP_60Urea"|
                   MAP_Urea == "0MAP_60Urea")

seg_ID <-
  rename(seg_ID, 
         "Rates" = "Rates_MAP", #new name = old name
         "Zone" =  "zones",
         "Yld" = "YldMassDry"
         )
...
#                  SegmentID != 1&
#                  SegmentID != 2)
seg_ID <- dplyr::filter(seg_ID, !between(seg_ID$SegmentID, 38, 43))
...
### should get this from harms database
 ...
 drop_download(path = "GRDC_Soil_Plant_Testing_Database/N&P 2019 data for analysis Vic 11March2020.xlsx", 
